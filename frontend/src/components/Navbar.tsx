...
import { Store, Package, ReceiptText, Plus } from 'lucide-react';
    ...
    <header className="sticky top-0 z-40 w-full border-b border-slate-200 bg-white/95 backdrop-blur-md dark:border-slate-800 dark:bg-slate-950/95">
      <div className="mx-auto flex h-16 max-w-4xl items-center justify-between px-4">
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/products/new"
            className="flex items-center gap-1 px-3 py-2 rounded-xl text-xs font-bold text-white bg-emerald-600 hover:bg-emerald-500 active:scale-95 shadow-xs shadow-emerald-600/20 transition"
          >
